    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Create your lab account</p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-slate-400 mb-1 uppercase tracking-widest">Confirm Password</label>
              <input
                type="password"
                value={confirm}
          ...
          <p className="text-center text-slate-500 text-xs mt-6">
            ...
            <button onClick={onGoLogin} className="text-cyan-400 hover:text-cyan-300 transition">
              Sign in →
            </button>
          </p>
        </div>
