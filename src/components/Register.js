    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#F4F1EA' }}>
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-[14px] text-[#1C1C1C] mt-1" style={{ fontFamily: 'Inter, sans-serif' }}>Create your lab account</p>
        </div>

        <div className="bg-white border-2 border-[#1C1C1C] rounded-[12px] p-8 shadow-2xl" style={{ boxShadow: '4px 4px 0px #1C1C1C' }}>
          <h2 className="text-lg font-bold text-[#1C1C1C] mb-6" style={{ fontFamily: 'DM Sans, sans-serif' }}>Register</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-[#1C1C1C] mb-1 font-medium uppercase" style={{ fontFamily: 'DM Sans, sans-serif' }}>Confirm Password</label>
              <input
                type="password"
                value={confirm}
